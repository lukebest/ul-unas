# VoiceBank+DEMAND (Valentini) — local copy
...
- **This copy**: resampled to 16 kHz for UL-UNAS. Source used: `edinburgh_datashare_48k_resampled_16k`.
...
- **16 kHz Hugging Face mirror** (opt-in `--allow_hf_fallback` only): `JacobLinCool/VoiceBank-DEMAND-16k`, declared CC BY 4.0. This copy used official DataShare, not the HF mirror.
